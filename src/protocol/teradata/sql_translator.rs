...
impl TeradataSqlTranslator {
    ...
    fn convert_sample(&self, sql: &str) -> String {
        ...
        result = sample_pct_re
            .replace_all(&result, " TABLESAMPLE BERNOULLI ($1)")
            .to_string();
    ...
    pub fn is_teradata_system_query(&self, sql: &str) -> bool {
        ...
        sql_upper.contains("DBC.") || sql_upper.contains("HELP ") || sql_upper.contains("SHOW ")
    }
