...
async fn test_enterprise_multi_table_join_aggregates() {
    ...
    projects_table
        .insert_row(vec![
            ...
            Value::Integer(10),
            Value::Double(200000.00),
        ])
        .unwrap();
    projects_table
        .insert_row(vec![
            Value::Integer(3),
            Value::Text("Data Migration".to_string()),
            Value::Integer(20),
            Value::Double(300000.00),
        ])
        .unwrap();
    projects_table
        .insert_row(vec![
            Value::Integer(4),
            Value::Text("Security Audit".to_string()),
            Value::Integer(30),
            Value::Double(100000.00),
        ])
        .unwrap();
    ...
    employees_table
        .insert_row(vec![
            ...
            Value::Integer(20),
            Value::Double(105000.00),
        ])
        .unwrap();
    employees_table
        .insert_row(vec![
            Value::Integer(104),
            Value::Text("David Wilson".to_string()),
            Value::Integer(20),
            Value::Double(110000.00),
        ])
        .unwrap();
    employees_table
        .insert_row(vec![
            Value::Integer(105),
            Value::Text("Eve Brown".to_string()),
            Value::Integer(30),
            Value::Double(120000.00),
        ])
        .unwrap();
    ...
    departments_table
        .insert_row(vec![
            Value::Integer(20),
            Value::Text("Data Science".to_string()),
    ...
    assert!(!dept_result.rows.is_empty());
    ...
    assert!(!resource_result.rows.is_empty());
    ...
    println!(
        "Result: {} departments with salary statistics",
        additional_result.rows.len()
    );
...
async fn test_join_aggregate_performance() {
    ...
    assert!(
        ...
        "JOIN performance should be reasonable"
    );
